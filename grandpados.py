...
parser = argparse.ArgumentParser(
    description="Grandpa, a partial HTTP stress tool for websites"
)
...
parser.add_argument(
    ...
    "--sockets",
    default=500,
    help="Number of sockets to use in the attack",
    type=int,
)
parser.add_argument(
    "-v",
...
def main():
    ...
    while True:
        try:
            logging.info(
                "Sending keep-alive headers | Recent socket count: %s",
                len(list_of_sockets),
            )
            ...
            logging.info("Terminating Grandpa")
            break
